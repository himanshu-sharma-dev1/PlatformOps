  ...
  openClusterEdit(cluster) {
    s.setClusterEditor({
      ...
      draft: {
        ...
        cluster_type: cluster.cluster_type || cluster.type || "standalone",
        ...
        registry_password: "",
        image_store: cluster.image_store || "",
      },
      error: ""
    });
  },
        ...
        if (s.clusterEditor.mode === "create") {
          const created = await api("/api/clusters", {
            ...
            body: JSON.stringify({
              ...
              cluster_type: draft.cluster_type || "standalone",
              ...
              registry_namespace: draft.registry_namespace || "",
              registry_auth: draft.registry_auth || "password",
              registry_password: draft.registry_password,
              image_store: draft.image_store || "",
            })
          });
        ...
        if (s.nodeEditor.mode === "create") {
          const created = await api("/api/nodes", {
            ...
            body: JSON.stringify({
              ...
              availability_zone: draft.availability_zone || "",
              auth_mode: draft.auth_mode || "none",
              monitor_port: Number(draft.monitor_port) || 9100,
              ingress_ports: draft.ingress_ports || "",
